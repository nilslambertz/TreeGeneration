...
namespace DefaultNamespace
{
    public class HelperFunctions
    {
        ...
        private static float getRandomV(float value)
        {
        ...
        {
            return scale + getRandomV(scaleV);
        }
        ...
        {
            return (zeroLength + getRandomV(zeroLengthV)) * scale_tree;
        }
        ...
        {
            return nLength + getRandomV(nLengthV);
        }
        ...
        {
            return nDownAngle + getRandomV(nDownAngleV);
        }
